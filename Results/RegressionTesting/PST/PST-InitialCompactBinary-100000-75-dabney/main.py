...
def main(jobID=-1,              # Used as an indicator for each run of the algorithm
    ...
    iFDDOnlineThreshold         = 75
    BatchDiscoveryThreshold     = 75 if not 'BatchDiscoveryThreshold' in globals() else BatchDiscoveryThreshold  # Minimum relevance required for representation expansion techniques to add a feature 
    ...
    #Agent ----------------------
    initial_alpha           = 1.0
    alpha_decay_mode        = 'dabney' # Decay rate parameter; See Agent.py initialization for more information
    boyan_N0                = 1000
    LAMBDA                  = 0
    LSPI_iterations         = 20
