...
def main(jobID=-1,              # Used as an indicator for each run of the algorithm
    ...
    iFDDOnlineThreshold         = 55 
    BatchDiscoveryThreshold     = 55 if not 'BatchDiscoveryThreshold' in globals() else BatchDiscoveryThreshold  # Minimum relevance required for representation expansion techniques to add a feature 
