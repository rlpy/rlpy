...
class PolicyEvaluationExperiment(Experiment):
    ...
    def evaluate(self, total_steps, episode_number):
        ...
        V_true, s_test, s_term, s_distr = self.domain.V(self.target_policy, discretization=self.num_eval_points_per_dim,
                                                        num_traj=self.num_traj_V, max_len_traj=200,
                                                        num_traj_stationary=self.num_traj_stationary)
