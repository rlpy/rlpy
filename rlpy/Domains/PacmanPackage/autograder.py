...
def evaluate(
        generateSolutions, testRoot, moduleDict, exceptionMap=ERROR_HINT_MAP, edxOutput=False, muteOutput=False,
        ...
        for t in sorted(tests):
            ...
            def makefun(testCase, solution_file):
                if generateSolutions:
                    ...
                    return (
                        lambda grades: testCase.writeSolution(
                            moduleDict,
                            solution_file)
                    )
                else:
